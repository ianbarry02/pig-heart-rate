% Code modified from Image Analyst Video Processing Tutorial last updated 2014 accessed 2023
% https://www.mathworks.com/matlabcentral/fileexchange/47726-video-processing-tutorial?s_tid=FX_rc3_behav
...
fontSize = 22;
        ...
        [filename, pathname] = uigetfile(...
            ...
            'Choose the movie file...');
        if pathname == 0; return; end
        dataFldr = pathname;
  
try
	videoObject = VideoReader(fullfile(pathname,filename))
	% Determine how many frames there are.
    % 
    % Can I iterate through
    % frames in first program, crop them and save them to an album, then
    % have this program go through the pics in the album?
	...
	writerObj = VideoWriter('test_vid.mp4');
	open(writerObj);
